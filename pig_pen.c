...
int verify_key(uint32_t epoch, unsigned const char *secret, const char *hash) {
  ...
  hmac_sha256_set_key(&sha256, 256, secret);
  ...
  hmac_sha256_update(&sha256, 4, time_in_4_bytes);
